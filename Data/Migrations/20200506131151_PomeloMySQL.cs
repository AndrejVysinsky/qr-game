...
{
    public partial class PomeloMySQL : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContestQuestionUsers", x => new { x.UserId, x.ContestQuestionId });
                    table.ForeignKey(
                        name: "FK_ContestQuestionUsers_ContestQuestions_ContestQuestionId",
                        column: x => x.ContestQuestionId,
                        principalTable: "ContestQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContestQuestionUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContestQuestionUsers_ContestQuestionId",
                table: "ContestQuestionUsers",
